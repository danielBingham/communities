...
module.exports = class SiteAdminsCanBanUsersMigration {
    ...
    async initForward() { 
        ...
        await this.database.query(`CREATE INDEX IF NOT EXISTS blocklist__user_id ON blocklist (user_id)`, [])
        await this.database.query(`CREATE INDEX IF NOT EXISTS blocklist__domain ON blocklist (domain)`, [])
    }

    async initBack() { 
        await this.database.query(`DROP INDEX IF EXISTS blocklist__user_id`, [])
        await this.database.query(`DROP INDEX IF EXISTS blocklist__domain`, [])
        await this.database.query(`DROP TABLE IF EXISTS blocklist`, [])
    }
