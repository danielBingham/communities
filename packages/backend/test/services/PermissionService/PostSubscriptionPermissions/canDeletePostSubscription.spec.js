...
describe("PostSubscriptionPermissions.canDeletePostSubscription()", function() {
    ...
    it("Should not allow user to view another user's PostSubscription", async function() {
        ...
        const canDeletePostSubscription = await service.can(currentUser, 'delete', 'PostSubscription', { postSubscription: postSubscription })

        expect(canDeletePostSubscription).toBe(false)
    })
    ...
    it("Should allow a user to view their own PostSubscription", async function() {
        ...
        expect(canDeletePostSubscription).toBe(true)
    })
})
