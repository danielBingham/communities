...
describe("PostSubscriptionPermissions.canViewPostSubscription()", function() {
    ...
    it("Should not allow user to view another user's PostSubscription", async function() {
        ...
        const canViewPostSubscription = await service.can(currentUser, 'view', 'PostSubscription', { postSubscription: postSubscription })

        expect(canViewPostSubscription).toBe(false)
    })
    ...
    it("Should allow a user to view their own PostSubscription", async function() {
        ...
        expect(canViewPostSubscription).toBe(true)
    })
})
