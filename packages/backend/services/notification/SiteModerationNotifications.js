...
module.exports = class SiteModerationNotifications {
    ...
    async ensureContext(currentUser, type, context, options) {
        ...
        if ( type === 'SiteModeration:update:comment-rejected-author' 
    ...
    async update(currentUser, type, context, options) {
        ...
        if ( type === 'SiteModeration:update:post-rejected-author') {
            ...
            await this.createNotification(context.postAuthor.id, 
                type, context, options) 

        } else if ( type === 'SiteModeration:update:comment-rejected-author' ) {
            ...
            await this.createNotification(context.commentAuthor.id, 
                type, context, options) 
        }
    }
