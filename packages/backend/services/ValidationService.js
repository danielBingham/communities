...
const SiteModerationValidation = require('./validation/SiteModerationValidation')
...
module.exports = class ValidationService {
    constructor(core) {
        ...
        this.siteModeration = new SiteModerationValidation(core, this)
    }
    ...
    async validatePostComment(currentUser, postComment, existing) {
        return await this.postComment.validatePostComment(currentUser, postComment, existing)
    }

    async validatePostReaction(currentUser, postReaction, existing) {
        return await this.postReaction.validatePostReaction(currentUser, postReaction, existing)
    }
    ...
    async validateSiteModeration(currentUser, siteModeration, existing) {
        return await this.siteModeration.validateSiteModeration(currentUser, siteModeration, existing)
    }
}
