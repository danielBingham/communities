...
describe('validatePostId', function() {
    it('Should return an error when null', function() {
        const value = null
        const errors = validation.PostComment.validatePostId(value)
...
describe('validateUserId', function() {
    it('Should return an error when null', function() {
        const value = null
        const errors = validation.PostComment.validateUserId(value)
...
describe('validateContent', function() {
    it('Should return an error when null', function() {
        const value = null
        const errors = validation.PostComment.validateContent(value)
    ...
    it("Should return an error when more than 5000 characters", function() {
        const value = `
    ...
    it("Should pass when less than 5000 characters", function() {
        const value = `
        
