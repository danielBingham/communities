...
const Contact = function({}) {
    ...
    return (
        <article className="contact">
            ...
            It may take up to a full business day at times, so please be
            patient with us right now.</p>
            ...
            <p>If you encounter bugs you have three avenues for reporting
                available to you: post in <a href="/group/communities-feedback-and-discussion">Communities Feedback and Discussion</a>,
                <a href="mailto:contact@communities.social">email us</a>, or <a href="https://github.com/danielbingham/communities/issues">open an issue</a> in the <a href="https://github.com/danielbingham/communities">Github Repository</a>. Any of them
