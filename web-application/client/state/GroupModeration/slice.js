...
const initialState = {
    /**
     * A dictionary of GroupModerations we've retrieved from the backend, keyed by
     * post.id.
     *
     * @type {object}
     */
...
export const GroupModerationSlice = createSlice({
    ...
    reducers: {
        ...
        setGroupModerationsInDictionary: function(state, action) {
        ...
        removeGroupModeration: function(state, action) {
            removeEntity(state, action)
            
            delete state.byGroupId[action.payload.entity.groupId]
        ...
        setGroupModerationQueryResults: setQueryResults,
        clearGroupModerationQuery: clearQuery,
        clearGroupModerationQueries: clearQueries,
        resetGroupModerationSlice: function() {
            return initialState
        }
    }
})
...
}  = GroupModerationSlice.actions

export default GroupModerationSlice.reducer
