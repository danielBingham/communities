...
- [x] As User1, make a post with an incomplete link (www.refseek.com, refseek.com).  Confirm highlighted.

#### Images

- [x] As User1, make an image post using a `.jpg`.
- [x] As User1, make an image post using a `.png`.
- [x] As User1, attempt to make a post with a corrupted `.png` - confirm failure.
- [x] As User1, attempt to make a post with a corrupted `.jpg` - confirm failure.

##### Videos

- [x] As User1, make a video post using a `.mp4`
- [x] As User1, make a video post using a `.mov`
- [x] As User1, make a video post using a `.avi`
- [x] As User1, make a video post using a `.webp`

- [x] As User1, make a video post using a corrupted `.mp4` - confirm failure.
- [x] As User1, make a video post using a corrupted `.mov` - confirm failure.
- [x] As User1, make a video post using a corrupted `.avi` - confirm failure.
- [x] As User1, make a video post using a corrupted `.webp` - confirm failure.
...
- [x] User1 has been created.
- [x] User2 has been created and has created at least three posts.
...
- [x] User1 has been created.
- [x] User2 has been created and has created at least three posts.
- [x] User1 has reacted to each of User2 posts.
...
- [x] User1 has been created.
- [x] User2 has been created and has created at least three posts.
- [x] User1 has reacted to each of User2's posts.
...
- [x] User1 has been created.
- [x] User2 has been created and is friends with User1.
- [x] User3 has been created and is **not** friends with User1.
- [x] User4 has been created and is friends with User1.
...
- [x] A Site admin user has been created.
- [x] User1 has been created.
- [x] User2 has been created and is friends with User1.
...
- [x] A Public Group, Public Group, has been created.
    - [x] The following subgroups of Public Group have been created:
        - [x] A Public Group named Public - Public Group
        - [x] A Private Group named Public - Private Group 
        - [x] A Hidden Group named Public - Hidden Group

- [x] User1 has been created and added as an admin of each group.
- [x] User2 has been created and added as a moderator of each group.
- [x] User3 has been created and added as a member of each group.

- [x] User4 has been created and added as an admin only of the top level groups.
- [x] User5 has been created an added as a moderator only of the top level groups.
- [x] User6 has been created and added as a member only of the top level groups.

- [x] User7 has been created and is a non-member of all groups.
...
- [x] A Public Group, Public Group, has been created.
    - [x] The following subgroups of Public Group have been created:
        ...
        - [x] A Private Group named Public - Private Group 
        - [x] A Hidden Group named Public - Hidden Group
- [x] A Private Group, Private Group, has been created.
    - [x] The following subgroups of Public Group have been created:
        - [x] A Public Group named Private - Public Group
        - [x] A Private Group named Private - Private Group 
        - [x] A Hidden Group named Private - Hidden Group
- [x] A Hidden Group, Hidden Group, has been created.
    - [x] The following subgroups of Public Group have been created:
        - [x] A Public Group named Hidden - Public Group
        - [x] A Private Group named Hidden - Private Group 
        - [x] A Hidden Group named Hidden - Hidden Group
...
- [x] Non-members can view GroupMembers.

- [x] Members can view GroupMembers.

##### Private Groups

- [x] Non-members **cannot** view GroupMembers.
...
- [x] User4 has been created and is a non-member of all groups.
...
- [x] Non-members can view posts.
- [x] Members can view posts.
- [x] Group Moderators can view posts.
- [x] Group Admins can view posts.

##### Private Groups

- [x] Non-members **cannot** view posts.
- [x] Members can view posts.
- [x] Group Moderators can view posts.
- [x] Group Admins can view posts.
...
- [x] Non-members can can see moderation status of posts.
- [x] Members can can see moderation status of posts.
- [x] Group Moderators can can see moderation status of posts.
- [x] Group Admins can can see moderation status of posts.

##### Private Groups

- [x] Non-members **cannot** can see moderation status of posts.
- [x] Members can can see moderation status of posts.
- [x] Group Moderators can can see moderation status of posts.
- [x] Group Admins can can see moderation status of posts.
...
- [x] Non-members **cannot** moderate posts.
- [x] Members **cannot** moderate posts.
- [x] Group Moderators can moderate posts.
- [x] Group Admins can moderate posts.
...
- [x] User2 has been created.
- [x] User3 has been created.
- [x] User4 has been created.
- [x] A Group has been created with User1 as admin, User2 as moderator, and
