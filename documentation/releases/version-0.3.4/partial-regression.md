...
This is a point release, but one that had some reasonably significant impacts,
so we're only going to run the portions of the test that are most relevant.
