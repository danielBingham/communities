...
- [x] Users can create Private subgroups of Private groups. 
    1. As User1, create a Private group called 'Private Group'.
    2. As User1, go to 'Private Group' -> Subgroups -> Create Subgroup.
        1. Upload an image.
        2. Crop the image.
        ...
        7. Leave Posting Permissions set to 'Members'.
        8. Submit.
    3. As User1, create a new post in 'Private -> Private Group'.
    4. As User2, a non-member of both groups, visit 'Private -> Private Group'.
        1. Confirm group is visible.
        2. Confirm User1's post is *not* visible.
        3. Confirm members are *not* visible.
        4. Attempt to visit User1's post using the permalink and confirm the post is *not* visible.
    5. As User1, invite User3 to 'Private Group'.
    6. As User3, accept User1's invitation to join 'Private Group'.
    7. As User3, visit 'Private -> Private Group'.
        1. Confirm group is visible.
        2. Confirm User1's post is *not* visible.
        3. Confirm members are *not* visible.
        4. Attempt to visit User1's post using the permalink and confirm the post is *not* visible.
...
- [x] Members with 'admin' role can update the title of a group.
...
- [x] Members with 'admin' role can update the short description of a group.

- [x] Members with 'admin' role can update the rules of a group.
